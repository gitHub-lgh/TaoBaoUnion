...
public class SelectedPageContentAdapter extends RecyclerView.Adapter<SelectedPageContentAdapter.InnerHolder> {
    ...
    private OnSelectedPageContentClickLinstener mContentItemClickListener = null;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mContentItemClickListener != null) {
                    mContentItemClickListener.onContentItemListener(itemData);
                }
            }
        });
    }
    ...
    public class InnerHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(SelectedContent.DataBean.TbkDgOptimusMaterialResponseBean.ResultListBean.MapDataBean itemData) {
            ...
            String pic_url = itemData.getPict_url();
            Glide.with(itemView.getContext()).load(pic_url).into(cover);
            if(TextUtils.isEmpty(itemData.getCoupon_click_url())){
                originalPrise.setText("晚啦，没有优惠卷了");
    ...
    public void setOnSelectedPageContentClickLinstener(OnSelectedPageContentClickLinstener linstener){
        this.mContentItemClickListener = linstener;
    }
    public interface OnSelectedPageContentClickLinstener{
        void onContentItemListener(IBaseInfo item);
    }
}
